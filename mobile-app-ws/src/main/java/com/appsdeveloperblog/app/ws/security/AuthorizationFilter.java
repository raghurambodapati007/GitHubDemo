...
public class AuthorizationFilter extends BasicAuthenticationFilter {
    ...
    public AuthorizationFilter(AuthenticationManager authManager,UserRepository userRepository) {
        ...
        super(authManager);
        System.out.println("7 in authorization filter");
    ...
    protected void doFilterInternal(HttpServletRequest req,
    	 ...
    	 System.out.println("8 in authorization filter");
        ...
        System.out.println("8(a) in authorization filter");
        UsernamePasswordAuthenticationToken authentication = getAuthentication(req);
        System.out.println("8(b) in authorization filter");
        SecurityContextHolder.getContext().setAuthentication(authentication);
        System.out.println("8(c) in authorization filter");
        chain.doFilter(req, res);
    }   
    
    private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request) {
    	
    	System.out.println("9 in authorization filter");
